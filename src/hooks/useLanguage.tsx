...
const translations = {
  en: {
    ...
    'community.launchDesc': 'Complete series from idea to final app, with community contributions.',
    ...
    'signup.placeholder': 'your@coevolvenetwork.com',
  ...
  es: {
    ...
    'community.launchDesc': 'Serie completa de idea a app final, con contribuciones comunitarias.',
    ...
    'signup.placeholder': 'tu@coevolvenetwork.com',
  ...
  ca: {
    ...
    'community.launchDesc': 'Sèrie completa d\'idea a app final, amb contribucions comunitàries.',
    ...
    'signup.placeholder': 'el.teu@coevolvenetwork.com',
  ...
  hi: {
    ...
    'community.launchDesc': 'विचार से अंतिम ऐप तक की पूरी श्रृंखला, सामुदायिक योगदान के साथ।',
    ...
    'signup.placeholder': 'आपका@coevolvenetwork.com',
