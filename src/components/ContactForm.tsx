      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-2xl mx-auto">
            Ready to connect with creators worldwide? Reach out to our team and let's discuss how Co-Evolve Network can support your creative journey.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-700 text-black">
              ...
              <a href="mailto:hello@coevolve.network" className="text-blue-500 hover:underline">hello@coevolve.network</a>
